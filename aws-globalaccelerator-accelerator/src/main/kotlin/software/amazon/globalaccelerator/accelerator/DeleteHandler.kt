...
class DeleteHandler : BaseHandler<CallbackContext?>() {
    override fun handleRequest(
        ...
        logger.logDebug("DELETE REQUEST: [%s]" + request.toString())
    ...
    companion object {
        ...
        private fun waitForDeletedStep(context: CallbackContext,
                                       ...
                                       logger: Logger): ProgressEvent<ResourceModel, CallbackContext?> {
            logger.logDebug("Waiting for accelerator with arn [${model.acceleratorArn}] to be deleted")
        ...
        private fun disableAccelerator(arn: String,
            ...
            logger.logDebug("Disabling accelerator with arn [$arn]")
        ...
        private fun deleteAccelerator(arn: String,
                                      ...
                                      agaClient: AWSGlobalAccelerator,
                                      logger: Logger) {
            logger.logDebug("Deleting accelerator with arn [$arn]")
